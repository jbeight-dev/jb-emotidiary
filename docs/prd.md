...
### 2.1 감정 선택 (10가지)
- 감정 선택 시 한글 감정명 아래에 영문 감정명 표시

| 감정 | 영문 | 이모지 | 영문 키 | 질문 예시 |
|------|------|--------|---------|-----------|
| 행복해요 | Happy | 😊 | happy | 오늘 무엇이 행복했나요? |
| 슬퍼요 | Sad | 😢 | sad | 무엇 때문에 슬펐나요? |
| 화나요 | Angry | 😠 | angry | 무엇 때문에 화가 났나요? |
| 무서워요 | Scared | 😨 | scared | 무엇이 무서웠나요? |
| 피곤해요 | Tired | 😴 | tired | 오늘 무엇을 했나요? |
| 사랑해요 | Love | 🥰 | love | 누구를 사랑하나요? |
| 짜증나요 | Annoyed | 😤 | annoyed | 무엇이 짜증났나요? |
| 평온해요 | Calm | 😌 | calm | 오늘 하루는 어땠나요? |
| 신나요 | Excited | 😆 | excited | 무엇이 신났나요? |
| 외로워요 | Lonely | 😔 | lonely | 누구와 함께하고 싶나요? |
...
## 6. 광고 (AdSense)
- Google AdSense 적용
- Publisher ID: `ca-pub-5542166319310724`
- 스크립트 위치: `index.html` `<head>` 섹션
